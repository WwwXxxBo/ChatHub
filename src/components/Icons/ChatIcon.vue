    ...
    <svg xmlns="http://www.w3.org/2000/svg" width="30" height="30" viewBox="0 0 24 24" :class="{ clicked }"
        ...
        <g fill="none">
            <path
                ...
                fill="url(#1752500502797-8547309_msgs_existing_0_0ccyrnbjh)" data-glass="origin"
                mask="url(#1752500502797-8547309_msgs_mask_1oucfezff)"></path>
            <path
                d="M1 9.99348C1.00003 11.624 1.44063 13.1472 2.19626 14.4646C2.38601 14.9255 2.27792 15.4945 2.15636 15.9568C1.97097 16.6619 1.62172 17.3398 1.21379 17.7485C1.0104 17.9522 0.945503 18.2561 1.04846 18.525C1.1515 18.7939 1.40329 18.9771 1.69077 18.9927C2.51536 19.0372 3.42875 18.8742 4.22582 18.6419C4.83702 18.4638 5.42053 18.2318 5.88387 17.9889C7.15411 18.645 8.57122 18.9955 10.0009 18.9955C14.9719 18.9954 18.9997 14.9668 19 9.99728C19 5.05316 15.0118 1.04141 10.0779 1C5.1088 1.00007 1 5.02371 1 9.99348Z"
                fill="url(#1752500502797-8547309_msgs_existing_0_0ccyrnbjh)" data-glass="clone"
                filter="url(#1752500502797-8547309_msgs_filter_6ydn1k8fj)"
                clip-path="url(#1752500502797-8547309_msgs_clipPath_akptrom4f)"></path>
            <path
                ...
                fill="url(#1752500502797-8547309_msgs_existing_1_bstyfjvi0)" data-glass="blur"></path>
            <path
                ...
                fill="url(#1752500502797-8547309_msgs_existing_2_623uwqc53)"></path>
            <defs>
                <linearGradient id="1752500502797-8547309_msgs_existing_0_0ccyrnbjh" x1="10" y1="1" x2="10" y2="19"
                    gradientUnits="userSpaceOnUse">
                    <stop stop-color="#575757"></stop>
                    <stop offset="1" stop-color="#151515"></stop>
                </linearGradient>
                <linearGradient id="1752500502797-8547309_msgs_existing_1_bstyfjvi0" x1="15.5" y1="7.25" x2="15.5"
                    y2="21.75" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#E3E3E5" stop-opacity=".6"></stop>
                    <stop offset="1" stop-color="#BBBBC0" stop-opacity=".6"></stop>
                </linearGradient>
                <linearGradient id="1752500502797-8547309_msgs_existing_2_623uwqc53" x1="15.5" y1="7.25" x2="15.5"
                    y2="15.647" gradientUnits="userSpaceOnUse">
                    <stop stop-color="#fff"></stop>
                    <stop offset="1" stop-color="#fff" stop-opacity="0"></stop>
                </linearGradient>
                <filter id="1752500502797-8547309_msgs_filter_6ydn1k8fj" x="-100%" y="-100%" width="400%" height="400%"
                ...
                <clipPath id="1752500502797-8547309_msgs_clipPath_akptrom4f">
                    <path
                        d="M22.75 14.4971C22.75 15.8083 22.3947 17.0325 21.7881 18.0918C21.4381 18.7473 22.0797 20.0133 22.5303 20.4648C22.7394 20.6742 22.8061 20.9874 22.7002 21.2637C22.5942 21.5399 22.3354 21.7282 22.04 21.7441C21.3651 21.7806 20.6264 21.6475 19.9893 21.4619C19.536 21.3299 19.098 21.1595 18.7354 20.9775C17.7323 21.4798 16.6207 21.7461 15.499 21.7461C11.4948 21.7459 8.2502 18.5019 8.25 14.5C8.25 10.498 11.4977 7.25 15.501 7.25C19.5037 7.25018 22.75 10.4949 22.75 14.4971Z"
                        fill="url(#1752500502797-8547309_msgs_existing_1_bstyfjvi0)"></path>
                </clipPath>
