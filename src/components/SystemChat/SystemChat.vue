...
// 引入组件
import SystemChatList from "@/components/SystemChat/SystemChatList/SystemChatList.vue";
import SystemChatWindow from "@/components/SystemChat/SystemChatWindow/SystemChatWindow.vue";
import EmptySystemChatWindow from '@/components/SystemChat/SystemChatWindow/EmptySystemChatWindow.vue'
  ...
  <div class="chat-assistant">
    <transition name="chat-assistant-left-transition">
      <div v-if="!isLeftClose" class="chat-assistant-left">
        <!-- 助手列表 -->
        <SystemChatList class="assistant-list" />
      </div>
    </transition>
    <div ref="chatAssistantRightRef" class="chat-assistant-right">
      ...
      <!-- 助手聊天窗口 -->
      <SystemChatWindow  
        v-if="assistantStore.getCurrentVirtualAssistant.id"
        :key="`chat-window-${assistantStore.currentVirtualAssistantId}`"
        class="chat-window"
      />
      <!-- 助手空状态 -->
      <EmptySystemChatWindow v-else />
    </div>
  </div>
</template>
